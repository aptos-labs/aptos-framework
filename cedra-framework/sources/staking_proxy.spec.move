spec cedra_framework::staking_proxy {
    ...
    /// Enforcement: Enforced via [https://github.com/cedra-labs/cedra-core/blob/main/cedra-move/framework/cedra-framework/sources/staking_contract.move#L87](SimpleMap).
    /// </high-level-req>
    ///
    spec module {
        pragma verify = true;
