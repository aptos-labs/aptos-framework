...
module cedra_std::bls12381 {
    ...
    fun test_signature_aggregation() {
        ...
        // multisigs[i] is a signature on "Hello, Cedraverse!" from signers 1 through i (inclusive)
    ...
    fun test_verify_multisig() {
        ...
        // multisigs[i] is a signature on "Hello, Cedraverse!" under agg_pks[i]
        let multisigs = vector[
        ...
        for (i in 0..pks.length()) {
            ...
            assert!(verify_multisignature(&multisigs[i], &apk, b"Hello, Cedraverse!"), 1);
        };
    }
